...
public class ColorControl extends AbstractPortControl implements ChangeListener, ActionListener, DocumentFocusListener {
    ...
    private void setValueFromControl() {
        port.setValue(new nodebox.graphics.Color(colorDialog.getColor()));
        //port.setValue(colorWell.getColor());
    }
...
//        final ColorSwatch colorSwatch = new ColorSwatch(port.asColor());
    ...
    private class ColorButton extends JButton {
        ...
        protected void paintComponent(Graphics g) {
            ...
            g.setColor(port.asColor().getAwtColor());
            g.fillRect(r.x, r.y, r.width - 1, r.height - 1);
        }
    }
}
