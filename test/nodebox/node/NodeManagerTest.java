...
//        Node rect1 = manager.get("demo").getRootMacro().getChild("rect1");
//        Node move1 = manager.get("demo").getRootMacro().getChild("move1");
...
//        for (String name : names) {
//            Node newInstance = newLib.getRootMacro().getChild(name);
