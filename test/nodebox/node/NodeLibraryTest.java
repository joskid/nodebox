...
//        assertTrue(test.getRootMacro().contains("alpha"));
//        assertTrue(test.getRootMacro().contains(alpha));
    }
...
//        library = NodeLibrary.fromFile(new File("test/polynodes.ndbx"), manager);
...
//        NodeLibraryManager manager = new NodeLibraryManager();
//        NodeLibrary newLibrary = NodeLibrary.fromXml("test", library.toXml(), manager);
//        Node newAlpha = newLibrary.getRootMacro().getChild("alpha");
//        Node newBeta = newLibrary.getRootMacro().getChild("beta");
...
//        NodeLibraryManager manager = new NodeLibraryManager();
//        NodeLibrary newLibrary = NodeLibrary.fromXml("test", xml, manager);
//        Node newNet = newLibrary.getRootMacro().getChild("net");
...
//        NodeLibraryManager manager = new NodeLibraryManager();
//        NodeLibrary newLibrary = NodeLibrary.fromXml("test", xml, manager);
//        Node newAlpha = newLibrary.getRootMacro().getChild(nodeName);
