 ...
 * <p/>
 * A Cycle detector might work on a per-node or per-port basis.
 ...
 * cyclic. On a per-port basis, the example would not cause a cycle. This implementation works on a per-node basis.
 */
