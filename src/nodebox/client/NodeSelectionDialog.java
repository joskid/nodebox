...
public class NodeSelectionDialog extends JDialog {
    ...
    private class NodeRenderer extends JLabel implements ListCellRenderer {
        ...
        public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
            ...
            String html = "<html><b>" + StringUtils.humanizeName(node.getName()) + "</b> - " + node.getDescription() + "<br><font color=#333333>" + node.getClass().getSimpleName() + " - </font> <font color=#666666>" + node.getLibrary().getName() + "</font></html>";
            setText(html);
            if (isSelected) {
