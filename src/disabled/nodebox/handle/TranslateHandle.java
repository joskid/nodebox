...
public class TranslateHandle extends AbstractHandle {
    ...
    public void draw(GraphicsContext ctx) {
        float x = node.getPort(txName).floatValue();
        float y = node.getPort(tyName).floatValue();
    ...
    public boolean mousePressed(Point pt) {
        ...
        float x = ox = node.getPort(txName).floatValue();
        float y = oy = node.getPort(tyName).floatValue();
